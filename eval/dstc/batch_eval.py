...
# DATA_ROOT = "/home/yizhe/data/GPT-2/dstc_grounded/"
CODE_ROOT = "/home/yizhe/Dropbox/2019GPT/large-scale-pretraining/dstc"
PYTHON_EXE = "/home/yizhe/anaconda2/bin/python"


def eval(prediction_path, output_path, data_type):
    os.chdir(CODE_ROOT)
    if data_type == "valid":
        ref_path = f'{CODE_ROOT}/data/valid.refs.txt'
        key_path = f'{CODE_ROOT}/data/valid.keys.txt'
    else:
...
""")
parser.add_argument("--input_dir", type=str, default="/home/yizhe/data/GPT-2/dstc/")
parser.add_argument("--data_type", type=str, help="could be 'valid' or 'test' ")
